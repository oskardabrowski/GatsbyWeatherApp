        ...
        if(place != '') {
            ...
            const Forecast = async () => {
                ...
                allData7.forEach(element => {
                    ...
                    const DailyWeather = new Weather(weather[0].id, clouds.all, weather[0].description, main.temp, main.feels_like, main.humidity, wind.speed, DateString, city.coord, city.country, city.name);
