...
const imagesCloudy = [
    <StaticImage class="image" src="../images/WeatherImages/Cloudy1.png" alt="Cloudy1"/>,
    <StaticImage class="image" src="../images/WeatherImages/Cloudy2.png" alt="Cloudy2"/>,
    <StaticImage class="image" src="../images/WeatherImages/Cloudy3.png" alt="Cloudy3"/>,
];
