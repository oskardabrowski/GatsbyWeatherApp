        ...
        if(place != '') {
            ...
            const Forecast = async () => {
                ...
                allData7.forEach(element => {
                    let weekDayName, splitedDate, dateString;
                    const {clouds, coord, main, weather, wind, dt_txt} = element;
                    ...
                    dateString = `${weekDayName}, ${splitedDate[2]}.${splitedDate[1]}.${splitedDate[0]}`;
