...
const ApiData = () => {
    ...
    useEffect(() => {
        ...
        if(showInfo) {
            ...
            info.style.clipPath = 'polygon(100% 0, 100% 0, 100% 100%, 100% 100%)';
        }
    }, [showInfo])
    return (
        <Container>
            ...
            <div className="DataPicker">
                <div className="GatsbyLogo" onMouseEnter={() => setShowInfo(!showInfo)} onMouseLeave={() => setShowInfo(!showInfo)}>
                    <SiGatsby className="ico" />
                    <div className="GatsbyLogo-desc">
                        Build with <a href="">Gatsby</a>
                    </div>
                </div>
