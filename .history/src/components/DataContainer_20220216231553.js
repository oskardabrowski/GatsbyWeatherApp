...
const DataContainer = ({WeekForecast}) => {
    ...
    const {dispatch, curtain, setCurtain} = useContext(GlobalAppContext);
            ...
            <div className="Container">
                ...
                <div className="Container-days">
                    {WeekForecast && WeekForecast.map((el, index) => {
                        let meanTemperature = 0, meantTempCount = 0;
                        ...
                        <div className="Container-days-day-temp">{(meanTemperature/meantTempCount).toFixed(1)} °C</div>
                    </div>
                    })}
                </div>
            </div>
