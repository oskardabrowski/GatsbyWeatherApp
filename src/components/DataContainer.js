...
import {WiThermometer, WiBarometer, WiRaindrops, WiStrongWind, WiCloudy} from 'react-icons/wi';
            ...
            <div className="Container">
                <div className="Container-top">
                    <div className="Container-top-general">
                        ...
                        <div className="Container-top-general-data">
                            <div className="Container-top-general-data-mostimportant">
                                ...
                                <div className="Container-top-general-data-mostimportant-degrees">{WeekForecast && (WeekForecast[Day].list[Hour].temperature -272.15).toFixed(1)} °C</div>
                            </div>
                    ...
                    <div className="Container-top-additional">
                        <div className="Container-top-additional-top">
                            ...
                            <div onClick={() => ChartHandler(Day, 'temperature', 'Temperatura [°C]')} className="Container-additional-top-temperature">
                                <div className="icon"><WiThermometer /></div>
                                <div className="info">{WeekForecast && (WeekForecast[Day].list[Hour].temperature-272.15).toFixed(1)} °C</div>
                ...
                <div className="Container-days">
                    {WeekForecast && WeekForecast.map((el, index) => {
                        ...
                        const hour = el.list[0].hours.split(':');
                        const hourNum = parseInt(hour[0])
                        return <div key={index} onClick={() => ChangeDayHandler(index)} className="Container-days-day">
                        <div className="Container-days-day-date">{date[1]}</div>
                        <div className="Container-days-day-ico">{el.list[0].findIco(hourNum)}</div>
                        <div className="Container-days-day-temp">{(el.list[0].temperature-272.15).toFixed(1)} °C</div>
                    </div>
                    })}
                </div>
            </div>
